...
<ul>
  ...
  <li><strong>Sentence Transformers</strong> – эмбеддинги для RAG</li>
  <li><strong>FAISS</strong> – индексный поиск похожих примеров и цензурных правил</li>
  <li><strong>Hugging Face Transformers</strong> – локальная модель токсичности</li>
  ...
  <li><strong>Ollama</strong> – локальный запуск LLM</li>
</ul>
...
<ul>
  ...
  <li>Виртуальная машина с запущенным сервером Ollama и установленной моделью.</li>
